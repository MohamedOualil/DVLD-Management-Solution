    ...
    public static class DomainErrors
    {
        ...
        public static class erUser
        {
            ...
            public static readonly Error InvalidCredentials =
                new("User.InvalidCredentials", "The provided username or password is incorrect.");
        ...
        public static class erDrivers
        {
            ...
            public static readonly Error DriverAlreadyExists =
                new("Driver.DriverAlreadyExists", "A driver record already exists for this person.");
        }
        ...
        {
            public static readonly Error NotFound =
                new("DetainedLicense.NotFound", "Detained license record with the specified ID was not found.");
            public static readonly Error InvalidId =
                new("DetainedLicense.InvalidId", "The detained license ID format is invalid.");
            public static readonly Error LicenseAlreadyDetained =
                new("DetainedLicense.LicenseAlreadyDetained", "This license is already currently detained.");
